...
-- All edges having the same label are all stored under a single
-- entry designated by the label.
...
-- We optimize for the common cases by handling them explicitly.
-- This optimization improves performance by a significant constant
