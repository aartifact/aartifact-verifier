...
--   Negative integers are used as "wildcards" that can match
--   any positive integer. In order for two index lists to
--   match, each negative integer instance must match the same
--   positive value.
