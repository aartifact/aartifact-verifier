...
----------------------------------------------------------------
-- | External interface and support functions. This wrapper is
--   needed in case the expression contains local variables.
...
----------------------------------------------------------------
-- | This checks the structure for a particular relation
--   instance. This currently takes linear time, this should be
--   much faster.
